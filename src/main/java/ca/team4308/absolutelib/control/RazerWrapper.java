...
public class RazerWrapper {
    ...
    public final Trigger RightTriggerTrigger;
    public final Trigger LeftTriggerTrigger;
    ...
    public RazerWrapper(int port) {
        ...
        this.RightTriggerTrigger = new Trigger(() -> getRightTriggerAsBoolean());
        this.LeftTriggerTrigger = new Trigger(() -> getLeftTriggerAsBoolean());
    }
