...
public final class PhysicsConstants {
    ...
    public static final double ATMOSPHERIC_PRESSURE = 100100.235;
    ...
    public static final double ANGLE_RESOLUTION = 0.1;
    public static final double RPM_RESOLUTION = 10.0;
