...
public class DoubleUtils {
     ...
     * returns a value in the range [{@code new_min}, {@code new_max}] such
     * that:
     *
     * <pre>
     * d = old_min  -> new_min
     ...
     *
     * @param d the value to map (typically in [{@code old_min},
     * {@code old_max}])
     ...
     * @return mapped value in the output range (possibly outside if {@code d}
    ...
    /**
     * Alternate form of
     * {@link #mapRange(double, double, double, double, double)} using different
     * parameter names.
     * <p>
     * Given an input {@code x} in the range [{@code in_min}, {@code in_max}],
     * returns a value in the range [{@code out_min}, {@code out_max}] using the
